...
public class KeyVaultADALAuthenticator {
	 ...
	 * @throws Exception
	 */
	private static AuthenticationResult getAccessToken(String clientId, String clientKey, String authorization, String resource) throws InterruptedException, ExecutionException, MalformedURLException {
